...
import 'package:manalyze/widgets/player_widget_dialogs/show_player_status_dialog.dart';
import 'package:manalyze/widgets/player_widget_dialogs/stopwatch_inkwell.dart';
                ...
                child: Icon(
                  ...
                  shadows: [
                    for (double i = 1; i < 5; i++)
                      Shadow(color: widget.shadowIncrement, blurRadius: 3 * i),
                  ],
                ),
              ),
            ),
                      ...
                      child: RotatedBox(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            shadows: [
                              for (double i = 1; i < 10; i++)
                                Shadow(color: colorPlayer, blurRadius: 3 * i),
                            ],
                          ),
                        ),
                      ),
            ...
            child: Center(
              child: RotatedBox(
                ...
                child: Icon(
                  ...
                  shadows: [
                    for (double i = 1; i < 10; i++)
                      Shadow(color: widget.shadowStatus, blurRadius: 3 * i),
                  ],
                ),
              ),
            ),
