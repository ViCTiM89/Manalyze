...
import 'package:manalyze/widgets/player_widget_dialogs/show_combo_tracker.dart';
import 'package:manalyze/widgets/player_widget_dialogs/show_commander_combos_dialog.dart';
import 'dart:math' as math;
import 'package:manalyze/widgets/player_widget_dialogs/show_player_lp_history_dialog.dart';
...
class ShowPlayerStatusDialog {
  static void showPlayerDialog(
    ...
    RotatedBox? parentRotatedBox = context
        .findAncestorWidgetOfExactType<RotatedBox>();
    if (parentRotatedBox != null) {
      double rotation =
          parentRotatedBox.quarterTurns *
          90 %
            ...
            style: TextStyle(
              ...
              shadows: [
                for (double i = 1; i < 10; i++)
                  Shadow(color: shadowColorCommanderDamage, blurRadius: 3 * i),
              ],
            ),
          ),
        ),
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(
              ...
              shadows: [
                for (double i = 1; i < 10; i++)
                  Shadow(color: counterColor, blurRadius: 3 * i),
              ],
            ),
          ),
        ),
